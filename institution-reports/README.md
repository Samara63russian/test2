...
1. При необходимости укажите публичный HTTPS-адрес API в `VITE_API_URL`. Если адрес не вшит при сборке, пользователь вводит выданный администратором адрес сервера на экране входа.
